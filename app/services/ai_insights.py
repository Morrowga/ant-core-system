...
from app.models.reports import Project, Report
...
class AIInsightsService(TenantService):
    ...
    async def generate_overview(self, start: date, end: date) -> dict:
        ...
        from app.models.attendance import LeaveRequest  # local import, mirrors dashboard.py's own style
        from app.models.company import Company
        ...
        from app.models.ai_insights import CompanyOverviewAnalysis
    ...
    async def _latest_project_analysis(self, project_id: int):
        from app.models.ai_insights import ProjectAnalysis
