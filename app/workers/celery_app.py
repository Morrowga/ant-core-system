...
celery_app = Celery(
    ...
    include=[
        ...
        "app.workers.tasks.ai_workload",
        "app.workers.tasks.work_thread_matching",
        "app.workers.tasks.health_reminders",
        "app.workers.tasks.presence_checks",
        "app.workers.tasks.shift_reminders",
        "app.workers.tasks.auto_close_sessions",
    ],
)
...
celery_app.conf.beat_schedule = {
    "alert-escalation-sweep": {
        "task": "app.workers.tasks.alerts.escalation_sweep",
        "schedule": 300.0,  # every 5 minutes
    },
    "issue-monthly-certificates": {
        "task": "app.workers.tasks.certificates.issue_monthly",
        "schedule": crontab(day_of_month=1, hour=2, minute=0),
    },
    "issue-yearly-certificates": {
        "task": "app.workers.tasks.certificates.issue_yearly",
