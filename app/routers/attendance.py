...
from app.schemas.attendance import (AttendanceSessionOut, CheckInRequest, DeskLocationIn,
...
async def location_history(employee_id: int, db: DB, day: date | None = None, user=DashUser):
    ...
    from app.models.attendance import AttendanceSession, DeskLocation, LocationPing
    from app.models.company import CompanySettings
    from app.services.attendance import DEFAULT_DESK_AREA_RADIUS_METERS, _distance_meters
