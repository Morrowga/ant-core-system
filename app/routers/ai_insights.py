...
"Ask your company" entry card. Same plan gating as the old /dashboard/ask
(Mid tier or higher), enforced via the existing require_plan_feature
dependency already used elsewhere in this codebase.
"""
from datetime import date

from fastapi import APIRouter, Depends, HTTPException

from app.core.dependencies import DB, ROLE_MANAGER, ROLE_OWNER, RequireActivePlan, require_plan_feature, require_role
...
router = APIRouter(
    ...
    dependencies=[Depends(require_plan_feature("ask_your_company")), RequireActivePlan],
)
