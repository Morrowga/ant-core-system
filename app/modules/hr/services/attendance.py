...
from app.modules.hr.models.attendance import AttendanceSession, DeskLocation, LeaveRequest, LocationPing
...
class AttendanceService(TenantService):
    ...
    async def check_in(self, lat: float | None, lng: float | None) -> AttendanceSession:
        ...
        from app.modules.hr.models.reports import OvertimeRequest
    ...
    async def today_invoice(self) -> dict:
        ...
        from app.modules.hr.models.attendance import BreakSession
    ...
    async def request_desk_location_change(self, lat: float, lng: float) -> "DeskLocationRequest":
        ...
        from app.modules.hr.models.attendance import DeskLocationRequest
