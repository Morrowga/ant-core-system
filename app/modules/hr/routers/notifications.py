...
from app.core.models.user import DeviceToken, Notification
from app.modules.hr.schemas.misc import DeviceRegisterIn, HeartbeatIn
...
async def get_preferences(user: CurrentUser, db: DB):
    from app.core.models.user import NotificationPreference
