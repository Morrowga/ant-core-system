...
@celery_app.task(name="app.modules.hr.workers.tasks.work_thread_matching.match_report", max_retries=3, default_retry_delay=30)
def match_report(report_id: int) -> None:
    from app.modules.hr.services.work_threads import match_report_sync
