...
@celery_app.task(name="app.modules.hr.workers.tasks.certificates.issue_monthly")
...
@celery_app.task(name="app.modules.hr.workers.tasks.certificates.issue_yearly")
