...
@celery_app.task(name="app.modules.hr.workers.tasks.ai_workload.analyze_report", max_retries=3, default_retry_delay=30)
def analyze_report(report_id: int) -> None:
    from app.modules.hr.services.ai_workload import analyze_report_sync
