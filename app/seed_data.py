...
from app.models.attendance import AttendanceSession, DeskLocation, LeaveRequest
from app.models.company import Company, CompanySettings, Subscription
from app.models.health import HealthLog
from app.models.misc import (Alert, AlertSetting, Certificate,
...
from app.models.reports import Project, Report, ReportComment, WorkThread, WorkThreadEntry
...
async def main() -> None:
    async with AsyncSessionLocal() as db:
        ...
        def make_user(email, full_name, role, team_id=None, joined_days_ago=180):
            return User(
                company_id=company.id, email=email, password_hash=hash_password(DEMO_PASSWORD),
        ...
        print(f"Seeded '{COMPANY_NAME}' (company_id={company.id}) successfully.\n")
