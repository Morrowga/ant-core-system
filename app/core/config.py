...
class Settings(BaseSettings):
    ...
    STRIPE_PRICE_STARTUP: str = ""  # legacy tier prices -- unused now that pricing is flat per module
    STRIPE_PRICE_MID: str = ""
    STRIPE_PRICE_ENTERPRISE: str = ""
    STRIPE_PRICE_HR: str = ""  # flat monthly price for the HR module
    STRIPE_PRICE_WAREHOUSE: str = ""  # flat monthly price for the Warehouse module
